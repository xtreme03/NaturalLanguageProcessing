...
class Window(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.init_ui()
    def init_ui(self):
        self.b=QtWidgets.QPushButton('SUMMARY')
        self.l=QtWidgets.QLabel('Enter the context you want to summarize in plot.txt file')
        ...
        self.setWindowTitle('TextSummarizer')
...
#print ('Input text:')
        ...
        summary=summarize(temp_str,ratio=0.5)
        g.write(summary)
        self.l.setText(summary)
